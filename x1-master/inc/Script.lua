...
function download_to_file(url, file_name)
  ...
  if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
      if data.photos_[0] then 
          ...
          Text = Text:gsub('Namei',data.last_name_ or "")
          ...
          if not redis:get("KLISH:ID") then
          sendMsg(msg.chat_id_,msg.id_,📬│لا يمكنني عرض صورتك لانك قمت بحظر البوت او انك لاتملك صوره في بروفيلك ...!'𖣤 ɴᴀᴍᴇ 𓄹𓄼 '..Namei..' .\n 𖣤 ᴜѕᴇʀɴᴀᴍᴇ 𓄹𓄼   '..UserNameID..' .\n𖥪 ᴍѕɢѕ 𓄹𓄼   '..msgs..' .\n𖥧 ѕᴛᴀᴛѕ 𓄹𓄼   '..msg.TheRank..' .\n𖦼 ʏᴏᴜʀ ɪᴅ 𓄹𓄼  '..msg.sender_user_id_..' .\n✰ ᴄʜ ᴇʟɪɴ 𓄹𓄼    @xclawx .\n┄─━━◉━━─┄',dl_cb,nil)
      else
          Text = redis:get("KLISH:ID")
          Text = Text:gsub('IDGET',msg.sender_user_id_)
          Text = Text:gsub('Namei',data.last_name_ or "")
      ...
      if redis:get("KLISH:ID") then
          ...
          sendMsg(msg.chat_id_,msg.id_,📬│لا يمكنني عرض صورتك لان المشرفين قامو بتعطيل الايدي بالصوره او انك قمت بحظر البوت ...!'𖣤 ɴᴀᴍᴇ 𓄹𓄼 '..Namei..' .\n 𖣤 ᴜѕᴇʀɴᴀᴍᴇ 𓄹𓄼   '..UserNameID..' .\n𖥪 ᴍѕɢѕ 𓄹𓄼   '..msgs..' .\n𖥧 ѕᴛᴀᴛѕ 𓄹𓄼   '..msg.TheRank..' .\n𖦼 ʏᴏᴜʀ ɪᴅ 𓄹𓄼  '..msg.sender_user_id_..' .\n✰ ᴄʜ ᴇʟɪɴ 𓄹𓄼    @xclawx .\n┄─━━◉━━─┄',dl_cb,nil)
      else
  end
  ...
  elseif Text== "تمام" then return sendMsg(msg.chat_id_,msg.id_,"العار ما يصيرله شي 😄")
